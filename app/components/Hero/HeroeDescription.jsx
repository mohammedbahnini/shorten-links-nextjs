...
function HeroeDescription() {
    return (
        <div className='max-w-[563px]'>
            ...
            <h2 className='text-neutral-gray text-[22px] font-medium leading-9  mb-10 mr-6'>{heroData.description}</h2>
            <Link href='/' className='bg-primary-cyan text-white px-10 py-4 rounded-full font-bold text-xl'>Get Started</Link>
        </div>
    )
}
